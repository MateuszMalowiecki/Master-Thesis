...
class Game_VPA:
    ...
    def try_guess_automata(self):
        try:
            ...
            guessed_automata=VPA(self.automata.calls_alphabet, self.automata.return_alphabet, self.automata.internal_alpahbet, range(n), stack_alphabet, initials, finals, initial_stack_symbol, transitions)
