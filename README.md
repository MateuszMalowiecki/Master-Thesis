...
Project is already launchable. You can launch it by installing Python(https://www.python.org/downloads/) and Kivy (https://kivy.org/doc/stable/gettingstarted/installation.html) and running file Game.py. 
